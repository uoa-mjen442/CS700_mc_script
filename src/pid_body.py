...
class PID(object):
    ...
    def __call__(self, input_, tick, dt=None):
        """
        ...
        now = tick
        if dt is None:
            dt = now - self._last_tick if (now - self._last_tick) else 0
        elif dt <= 0:
        ...
        main.display_queue.put("output: p {}, i {}, d {}".format(self._proportional, self._integral, self._derivative))
