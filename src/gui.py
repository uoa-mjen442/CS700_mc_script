...
class ExampleApp(tk.Tk):
    def __init__(self):
        ...
        title = tk.Label(self, text='Battery Management GUI', font="Times 20 italic bold")
        title.grid(row=2, column=0, columnspan=2)
        v = tk.Scrollbar(self, orient='vertical')
        v.grid(row=2, column=4)
        ...
        self.text = tk.Text(self, wrap="word", yscrollcommand=v.set)
        self.text.grid(row=2, column=2, columnspan=3, rowspan=11)
        ...
        label_time_multiplier = tk.Label(self, text="tick rate: ")
